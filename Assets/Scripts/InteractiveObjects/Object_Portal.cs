...
public class Object_Portal : MonoBehaviour, ISaveable
{
    ...
    [SerializeField] private Vector2 defaultPosition; // where portal appear in town
    [SerializeField] private string townSceneName = "Level_0";

    [SerializeField] private Transform respawnPoin;
    ...
    public Vector3 GetPosition() => respawnPoin != null ? respawnPoin.position : transform.position;
    ...
    public void LoadData(GameData data)
    {
        ...
        returnSceneName = data.protalDestinationSceneName;
    }
    ...
    public void SaveData(ref GameData data)
    {
        ...
        if (isActive && InTown() == false)
        {
            ...
            data.protalDestinationSceneName = currentSceneName;
        }
        else
        {
